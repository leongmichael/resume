...
\begin{rSection}{Experience}
	...
	\begin{rSubsection}{FRC 604 Quixilver Robotics}{June 2020 - Present}{VP of Engineering}{San Jose, CA}
        ...
        \item Developed particle filter robot localization software using both odometry from motor encoders and computer vision (utilized PhotonVision/OpenCV to detect AprilTag targets).
...
\begin{rSection}{Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Libraries + Frameworks & Flask, MongoDB, Firebase, Express, React, Node, React-Native, Expo, Matplotlib, Numpy \\
