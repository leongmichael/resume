...
\begin{rSection}{Projects}
    ...
    \begin{rSubsection}{Canvas Final Grade Calculator}{}{GitHub Link: \underline{\href{https://github.com/leongmichael/canvas-final-grade-calculator}{https://github.com/leongmichael/canvas-final-grade-calculator}}}{}
        ...
        \item 500+ users, 5.0 stars on Chrome Web Store.
            \item Skills: React.ts, Node.js

	\end{rSubsection}

     \begin{rSubsection}{LearnIt}{}{GitHub Link: \underline{\href{https://github.com/leongmichael/learn-it}{https://github.com/leongmichael/learn-it}}}{}
		\item AI-powered video generator for math and physics based on user prompts.
            \item Skills: React.js, Electron.js, Manim, Google Gemini 1.5, FastAPI, Deepgram
